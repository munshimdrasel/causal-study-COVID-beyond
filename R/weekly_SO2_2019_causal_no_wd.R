...
#
#
#   synth_eq <- SO2..tons. ~ inputed+ tmmx + rmax + pr + vs #omiting wind direction
#
...
# save(result_so2_weekly_2019, file="data/result_so2_weekly_2019_no_wd.RData")

load ("data/result_so2_weekly_2019_no_wd.RData")
load ("data/facility_so2_2019.RData")


result_so2_weekly_2019_no_wd <- result_so2_weekly_2019
...
for (i in 1:length(facility)) {
  so2.emis <- na.omit(as.data.frame(result_so2_weekly_2019_no_wd[[i]][[2]]$Y.bar))
