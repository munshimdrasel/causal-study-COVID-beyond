...
# units<- aggregate(list (SO2.tons.ct=units_ct_emission_2020$SO2.tons.ct
...
#                                        startday = paste0( years.run[1], '-12-31'),
...
month.locs.u <- lapply( years.run, function( y) 
  disperseR::calculate_exposure( year.E = y,
                                 year.D = y,
                                 link.to = 'grids',
                                 pollutant = 'SO2.tons.ct', #changed here
                                 rda_file = "loaded",
