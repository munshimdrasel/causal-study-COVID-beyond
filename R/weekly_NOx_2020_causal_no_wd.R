...
# 
# 
# save(result_nox_weekly_2020, file="data/result_nox_weekly_2020_no_wd.RData")
load ("data/result_nox_weekly_2020_no_wd.RData")
load ("data/facility_nox_2020.RData")
...
pdf(file = 'plots/counterfactual_plots_nox_2020_no_wd.pdf', onefile = TRUE, paper = 'A4',
...
for (i in 1:length(facility)) {
  ...
  att.avg <-result_nox_weekly_2020[[i]][[2]]$att
...
names(all.facility.nox.2020)[names(all.facility.nox.2020) == 'att.avg'] <- 'ATT'
